// src/pages/MyPage/ChallengeRequests.jsx
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.tableContainer}>
        ...
        {requests.length === 0 ? (
          <div className={styles.empty}>대기중인 요청이 없습니다.</div>
        ) : (
          requests.map(req => (
            ...
            >
              ...
              <div>{new Date(req.application_deadline).toLocaleDateString()}</div>
              <div className={styles.actions}>
                <button
                  className={styles.approveBtn}
                  onClick={() => handleApprove(req.challenge_id)}
                >
                  승인
                </button>
                <button
                  className={styles.rejectBtn}
                  onClick={() => handleReject(req.challenge_id)}
                >
                  거절
                </button>
              </div>
